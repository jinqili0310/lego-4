...
function createQuestions() {
	...
	prescripted_questions[2] = new Question(["https://kikijinqili.github.io/assets/lego/LEGO%20GIF4.gif"], [""], 3, 0);
	...
	prescripted_questions[8] = new Question(["How else can I help you today? "], ["Learn More About LEGO 💡", "Explore The Products 🎪", "View Your Orders 💻", "Fun for Fans 🎮"], 9, 1);
	prescripted_questions[9] = new Question(["Sounds good. What kind of products can I help you find?"], ["Electronic Products 📱", "Brick Sets 🔨"], 10, 1);
	prescripted_questions[10] = new Question(["Which category do you want to explore?"], ["New ✨", "Popular 🔥", "Age 👶", "Theme 🚀"], 11, 1);
	prescripted_questions[11] = new Question(["Are you interested in any of these brick sets?"], ["Jungle Rescue 🐘", "Friends Central Perk ☕", "Architecture Sets 🗽", "Monster Truck 🚛"], 12, 2);
	prescripted_questions[12] = new Question(["Is this for you or someone you care about? 😉"], ["Only for me", "For someone else"], 13, 1);
	prescripted_questions[13] = new Question(["Got it. How else can I help?"], ["I’m all set. 😆", "I’d like more help."], -1, 0);
