...
class SimpleCardDark extends Component {
	...
	render() {
		return (
			<Card className="bg-dark text-white card-style simple-medium-card">
				<Card.Img src={this.props.src} alt="Card image" className="card-image simple-medium-card-image" />
